...
gmt psbasemap -Ya${y_position} -Xa${x_position}  ${R_options_k} ${J_options} -Bx+l"x (km)" -By+l"y (km)"  -Ba${half_tick_k}f${eighth_tick_k} -BSWen -K -P -O >> ${plot}
...
gmt psbasemap -Ya${y_position} -Xa${x_position}  ${R_options_k} ${J_options} -Bx+l"x (km)" -By  -Ba${half_tick_k}f${eighth_tick_k} -BSWen -K -P -O >> ${plot}
...
gmt psxy glacial_index.txt -Xa${x_position} -Ya${y_position} -BWnes -Bxa${xint}f${xsubint}+l"Time (years)" -Bya${yint}f${ysubint}+l"Index"   ${J_options} ${R_options} -V -P -O -K -Wthick,black >> ${plot}

gmt pstext << END_CAT -Xa${x_position} -Ya${y_position}  ${J_options} ${R_options} -F+cTL+f12p -D0.1/-0.1 -P -K -O  >> ${plot}
(c)
END_CAT
