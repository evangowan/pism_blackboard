...
gmt pstext << END_CAT  ${J_options} ${R_options}  -P -K -O -F+f10p,Helvetica,black+jcb+a-90 -N  >> ${plot}
...
gmt pstext << END_CAT  ${J_options} ${R_options}  -P -O -F+f10p,Helvetica,black+jcb+a-90 -N >> ${plot}
