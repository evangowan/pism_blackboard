...
new_basal_50_cover_lowangle2_phi20_wet3_high_20000 1 2 20 50 80 20000
new_basal_50_cover_lowangle2_phi20_wet3 1 2 20 50 80 25000
new_basal_50_cover_lowangle2_phi20_wet3_high_30000 1 2 20 50 80 30000
new_basal_50_cover_lowangle2_phi20_wet3_high_35000 1 2 20 50 80 35000
new_basal_50_cover_lowangle2_phi20_wet3_high_40000 1 2 20 50 80 40000
end_cat
...
xmin=$(echo ${maxtime} | awk '{print $1 - 4.1}')
xmax=$(echo ${maxtime} | awk '{print $1 - 2.9}')

y_label_position=$(echo ${maxtime} | awk '{print $1 - 4.6}')
...
gmt psxy ts_1_m.txt -Y${height}c  ${J_options} ${R_options} -P -O -K -Wthick,blue -B+t"Index year=${maxtime}" --FONT_TITLE=8p >> ${plot}
