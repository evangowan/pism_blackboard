...
plot="plots/velocity_compare_sedphi_lowcover.ps"


cat << end_cat > phi_val.txt
new_basal_50_cover_lowangle2 1 2 30 50
new_basal_95_cover_lowangle2 1 2 30 95
new_basal_50_cover_lowangle2_phi20 1 2 20 50 
new_basal_95_cover_lowangle2_phi20 1 2 20 95
end_cat
...
gmt psxy ts_1_m.txt -Y${height}c  ${J_options} ${R_options} -P -O -K -Wthick,blue -B+t"S@-f@-=${cover}% @~\146@~@-sed@-=${phi_sed}" --FONT_TITLE=8p >> ${plot}
