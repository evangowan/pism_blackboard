...
mv -f testing3.nc pism_start.nc 

rm  testing.nc testing2.nc ${variable}_replace2.nc ${variable}_replace.nc y_values.nc x_values.nc mask.nc zero_grid.nc tillcover_temp.nc
